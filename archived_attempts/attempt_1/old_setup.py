...
class UI:
	def __init__(self):
		...
		self.btn4_New = Button(frame_buttons, text=btn4_New_text, command=command_New_101)  # "New"
		...
		self.canvas = Canvas(window_root_MainH, width=GameBoardWidth, height=GameBoardHeight)
		canvas.pack()
